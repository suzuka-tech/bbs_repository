...
if (!isset($_POST['thread_id']) || !is_numeric($_POST['thread_id']) ) {
    ...
    try{
       ...
       $stmt = $pdo->prepare("
            ...
            ");
        $stmt->bindValue(':id', $thread['id'], PDO::PARAM_INT);
        $stmt->execute();
            ...
            <div class="threads-box">
                    ...
                    <?php if(isset($_SESSION['user'])): ?>
                        <div class="reply">
                            ...
                            <form action="reply.php" method="post">
                                ...
                                <textarea name="body" placeholder="返信を作成…"></textarea>
                    ...
                    <?php else: ?>
                        <div class="reply login">
                            ...
                            <h3>登録して返信<i class="fa-solid fa-angle-down"></i></h3>
                                ...
                                <div class="flex-top">
                                    ...
                                    <?php if ($post['user_id'] === $_SESSION['user_id']): ?>
                                        ...
                                        <div class="edit">
                                            ...
                                            <a href="edit_post.php?post_id=<?= $post['id'] ?>&thread_id=<?= $thread['id'] ?>&user_id=<?= $thread['user_id'] ?>">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                             </a>
                                        </div>
                                        <div class="trash">
                                            <form action="delete_post.php" method="post" onsubmit="return confirm('返信を本当に削除しますか？');">
